...
class BaseAviary(gym.Env):
    ...
    def _housekeeping(self):
        ...
        drone_urdf_path = str(files('gym_pybullet_drones').joinpath('assets', self.URDF))
        self.DRONE_IDS = np.array([p.loadURDF(drone_urdf_path,
                                              self.INIT_XYZS[i,:],
    ...
    def _parseURDFParameters(self):
        ...
        """
        URDF_TREE = etxml.parse(files('gym_pybullet_drones').joinpath('assets', self.URDF)).getroot()
