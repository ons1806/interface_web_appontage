...
class DSLPIDControl(BaseControl):
    ...
    def __init__(self,
        ...
        if drone_model not in [DroneModel.CF2X, DroneModel.CF2P, DroneModel.QUADRICOPTER]:
             print("[ERROR] in DSLPIDControl.__init__(), DSLPIDControl requires DroneModel.CF2X, DroneModel.CF2P or DroneModel.QUADRICOPTER")
             exit()
        ...
        self.MIN_PWM = 20000
        self.MAX_PWM = 65535
        if self.DRONE_MODEL in [DroneModel.CF2X, DroneModel.QUADRICOPTER]:
